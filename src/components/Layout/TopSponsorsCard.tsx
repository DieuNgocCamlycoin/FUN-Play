  ...
  return (
    ...
    >
      ...
      <Avatar className={cn(
        ...
        <AvatarFallback className="bg-gradient-to-br from-[#FF00E5] to-[#7A2BFF] text-white text-xs font-bold">
          {(sponsor.displayName || sponsor.username).charAt(0).toUpperCase()}
        </AvatarFallback>
      </Avatar>

      {/* Name */}
      <span className="flex-1 text-left text-sm font-semibold text-[#FF00E5] truncate">
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center gap-2 mb-4">
        <Gem className="h-5 w-5 text-[#FF00E5] drop-shadow-[0_0_10px_rgba(255,0,229,0.8)]" />
        <h2 className="text-lg font-black italic bg-gradient-to-r from-[#FF00E5] via-[#7A2BFF] to-[#00E7FF] bg-clip-text text-transparent">
          TOP SPONSORS
        </h2>
      </div>
      ...
      <motion.div whileTap={{ scale: 0.97 }} className="mt-4">
        <Button
          ...
          className="w-full bg-gradient-to-r from-[#FF00E5] via-[#7A2BFF] to-[#00E7FF]
            ...
            border-0 rounded-full py-2.5 h-11"
        >
