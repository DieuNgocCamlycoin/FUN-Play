  ...
  return (
    <div
      className={cn(
        ...
        rank === 1 && "border-[#FFD700]/50 bg-gradient-to-r from-[#FFD700]/15 to-[#7A2BFF]/10"
      )}
    >
      <span className="text-xs">{getRankBadge(rank)}</span>
      <Avatar className="h-5 w-5 border border-[#7A2BFF]/30">
        <AvatarImage src={user.avatar_url || undefined} />
        <AvatarFallback className="text-[10px] bg-gradient-to-br from-[#7A2BFF] to-[#FF00E5] text-white">
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* View All Text */}
        <div className="pt-2 border-t border-[#7A2BFF]/20 text-center">
