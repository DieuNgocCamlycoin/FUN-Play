...
CREATE OR REPLACE FUNCTION public.get_public_users_directory()
 RETURNS TABLE(user_id uuid, username text, display_name text, avatar_url text, avatar_verified boolean, created_at timestamp with time zone, total_camly_rewards numeric, claimed_camly numeric, unclaimed_camly numeric, view_rewards numeric, like_rewards numeric, comment_rewards numeric, share_rewards numeric, upload_rewards numeric, signup_rewards numeric, bounty_rewards numeric, manual_rewards numeric, posts_count bigint, videos_count bigint, comments_count bigint, views_count bigint, likes_count bigint, shares_count bigint, donations_sent_count bigint, donations_sent_total numeric, donations_received_count bigint, donations_received_total numeric, mint_requests_count bigint, minted_fun_total numeric)
 LANGUAGE sql
...
CREATE OR REPLACE FUNCTION public.get_users_directory_stats()
 RETURNS TABLE(user_id uuid, username text, display_name text, avatar_url text, wallet_address text, created_at timestamp with time zone, banned boolean, avatar_verified boolean, pending_rewards numeric, approved_reward numeric, total_camly_rewards numeric, view_rewards numeric, like_rewards numeric, comment_rewards numeric, share_rewards numeric, upload_rewards numeric, signup_rewards numeric, bounty_rewards numeric, manual_rewards numeric, posts_count bigint, videos_count bigint, comments_count bigint, views_count bigint, likes_count bigint, shares_count bigint, donations_sent_count bigint, donations_sent_total numeric, donations_received_count bigint, donations_received_total numeric, mint_requests_count bigint, minted_fun_total numeric)
 LANGUAGE sql
 STABLE SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
