...
BEGIN
  ...
  -- Always compute raw action_base from source tables to catch activity
  -- after the daily cron (aggregate_features_user_day runs at 02:00 AM)
  SELECT
  ...
  IF v_action_base_raw > v_action_base THEN
    ...
    -- Also get consistency from profile if features were stale
